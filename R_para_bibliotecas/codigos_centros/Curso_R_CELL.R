...
## CARGAR SET DE DATOS
cell = read_csv("archivos_bibliografxs_openrefine/CELLLIMPIEZA-2018.csv")
...
cell[is.na(cell)] = 0
colnames (cell)
columnas = colnames (cell) 
total_articulos = nrow(cell)
total_nuevas_citas_2017 = length (cell$`Nuevas 2017`[cell$`Nuevas 2017`>0])
articulos_citas_reconocidas_2017 = length (cell$`Reconocidas 2017`[cell$`Reconocidas 2017`<0])
...
total_nuevas_citas_2017 <- sum(cell$`Nuevas 2017`[cell$`Nuevas 2017` >0])
